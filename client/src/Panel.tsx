  ...
  return (
    <div className="panel">
      ...
      {step === 0 && (
        <>
          <p>
            Use this tool to see how far you can get with $3 on an Citibike E-bike with a
            membership.
          </p>
      ...
      {step === 2 && (
        <>
          <p>
            This is how far you could ride if we capped Citibike fares at $3 for all rides under 45
            minutes.
          </p>
        </>
      )}
